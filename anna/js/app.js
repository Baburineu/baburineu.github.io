...
var typed = new Typed('#text', {
    strings: [' — денем солідарності жінок у боротьбі за повні політичні, економічні і соціальні права! Прийнятий на пропозицію Клари Цеткін, учасниці II Міжнародної конференції жінок-соціалісток (Копенгаген, серпень 1910 р.)\n',
        ...
        'Нехай ластівки зів \'ють гнізда над вашими вікнами і принесуть у ваш дім благополуччя і взаєморозуміння, а' +
        ' перші промені весняного сонечка вкажуть на щасливу стежку вашій долі!\n'],
    startDelay: 3000,
    typeSpeed: 50,
    backSpeed: 0,
    fadeOut: true,
